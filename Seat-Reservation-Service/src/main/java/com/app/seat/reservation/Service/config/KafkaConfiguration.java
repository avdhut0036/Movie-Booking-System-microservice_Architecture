package com.app.seat.reservation.Service.config;
...
public class KafkaConfiguration {
    ...
    public NewTopic createNewTopic() {
        return new NewTopic(EventsConstant.RESERVATION_EVENT_TOPIC, 3, (short) 1);
    }
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, EventsConstant.RESERVATION_GRP);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JacksonJsonDeserializer.class);
        //props.put(JacksonJsonDeserializer.USE_TYPE_INFO_HEADERS, false);
        //props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES,"com.app.commons.createdEvents");
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        return
                new DefaultKafkaProducerFactory<>(producerConfig(), serializer, jsonSerializer);
    }
