package com.app.payment.service.config;
...
public class KafkaConfig {
    ...
    public NewTopic createNewTopic() {
        return new NewTopic(EventsConstant.PAYMENT_EVENT_TOPIC, 3, (short) 1);
    }
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, EventsConstant.PAYMENT_GRP);
